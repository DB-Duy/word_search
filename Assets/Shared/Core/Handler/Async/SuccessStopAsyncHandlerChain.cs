...
{
    public class SuccessStopAsyncHandlerChain : IAsyncHandler, ISharedUtility
    {
        private readonly IAsyncHandler[] _handlers;

        public SuccessStopAsyncHandlerChain(params IAsyncHandler[] handlers)
        {
            _handlers = handlers;
        }
    ...
    public class SuccessStopAsyncHandlerChain<T> : IAsyncHandler<T>, ISharedUtility
    {
        private readonly IAsyncHandler<T>[] _handlers;

        public SuccessStopAsyncHandlerChain(params IAsyncHandler<T>[] handlers)
        {
            _handlers = handlers;
        }
