...
{
    public class AdReadyParams : BaseTrackingEvent, IConvertableEvent, ICountEvent
    {
        public override string EventName => "ad_ready";
        ...
        public static AdReadyParams Interstitial(string placement) => new(AdUnit.Interstitial, TrackingConst.InterstitialAdReadyCounterId, placement);
        public static AdReadyParams Rewarded(string placement) => new(AdUnit.Rewarded, TrackingConst.RewardedAdReadyCounterId, placement);
        public static AdReadyParams Audio(string placement) => new(AdUnit.Audio, TrackingConst.AudioAdReadyCounterId, placement);

        public AdReadyParams(AdUnit adUnits, string counterKey, string placement)
        {
            ADUnits = adUnits;
            CountKey = counterKey;
            Placement = placement;
