...
{
    [System.Serializable]
    public class SessionStartEvent : BaseTrackingEvent, IConvertableEvent
    {
        [JsonProperty("event_name")] public override string EventName => "session_start_customs";
        ...
        public SessionStartEvent(long sessionId, string className = null, string packageName = null)
        {
            SessionId = sessionId;
            ClassName = className;
