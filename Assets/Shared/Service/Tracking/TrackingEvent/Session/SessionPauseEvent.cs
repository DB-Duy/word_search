...
{
    [System.Serializable]
    public class SessionPauseEvent : BaseTrackingEvent, IConvertableEvent
    {
        [JsonProperty("event_name")] public override string EventName => "session_pause_customs";
        ...
        public SessionPauseEvent(long sessionId, string className = null, string packageName = null)
        {
            SessionId = sessionId;
            ClassName = className;
