...
namespace Shared.View.Ad
{
    ...
    public class ExcludeBannerAdArea : MonoBehaviour
    {
        ...
        {
            [SerializeField] internal bool respectSafeArea = false;
        }
        ...
        private float _adHeight = 50;
        private float _adHeightInPixels;
...
#if UNITY_IOS
            _platformSettings = iOS;
#else
            _platformSettings = android;
#endif
        ...
        void ApplySafeArea (Rect r)
        {
            ...
            {
                if (!_platformSettings.respectSafeArea)
                {
                    r.x = 0;
                    r.y = 0;
                    r.width = Screen.width;
                ...
                r.y += _adHeightInPixels;
                r.height -= _adHeightInPixels;
